...
Written for [Status](https://status.app/). Reviewed by [jorge-campo](https://github.com/jorge-campo). Published at [status.app/help/profile/sync-your-profile-across-devices](https://status.app/help/profile/sync-your-profile-across-devices).
