...
sidebar_position: 3
description: >-
  An integration procedure: pairing Keycard Shell with MetaMask so transactions are signed on the device rather than in the browser.
tags: [procedure, keycard]
---

![A header image showing the MetaMask logo and a Keycard Shell device](/img/keycard/connect-keycard-shell-to-metamask-header.png)

:::info[Sample]

Written for [Keycard](https://keycard.tech/). Reviewed by [guylouis](https://github.com/guylouis), [phift](https://github.com/phift). Published at [keycard.tech/help/connect-keycard-shell-to-metamask](https://keycard.tech/help/connect-keycard-shell-to-metamask).
...
<Admonition type="tip">
    After connecting, you can [create transactions](https://keycard.tech/help/sign-a-transaction-using-keycard-shell) in MetaMask.
</Admonition>
