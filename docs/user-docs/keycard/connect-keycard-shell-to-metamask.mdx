...
Written for [Keycard](https://keycard.tech/). Reviewed by [guylouis](https://github.com/guylouis), [phift](https://github.com/phift).

[View the published version ↗](https://keycard.tech/help/connect-keycard-shell-to-metamask)
