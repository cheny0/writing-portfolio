---
title: More Keycard writing
sidebar_position: 4
description: >-
  The full list of Keycard Shell help articles I wrote, with links to the live pages.
---

I wrote 12 of the 31 articles in the Keycard help centre, and about 62% of
...
| Article | Words | Read it |
| --- | ---: | --- |
| [Set up your Keycard with Keycard Shell](./set-up-your-keycard-with-keycard-shell.mdx) | 962 | Reproduced here |
| [Connect Keycard Shell to Sparrow Wallet](https://keycard.tech/help/connect-keycard-shell-to-sparrow-wallet) | 492 | keycard.tech |
...
| [Change your Keycard PIN or duress PIN](https://keycard.tech/help/change-your-keycard-pin-or-duress-pin) | 213 | keycard.tech |
| [Enable or disable data transfer on Keycard Shell](https://keycard.tech/help/enable-or-disable-data-transfer-on-keycard-shell) | 156 | keycard.tech |
| [Set a Keycard PUK](https://keycard.tech/help/set-a-keycard-puk) | 93 | keycard.tech |

All of them cover Keycard Shell, a hardware wallet and air-gapped transaction
signer: device setup, PIN and duress-PIN handling, wallet integrations, firmware
updates, and recovery when a card is blocked or lost.
