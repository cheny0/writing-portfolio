...
sidebar_position: 3
description: >-
  A tabbed procedure covering profile syncing on mobile and desktop, including how to pair a new device and how to turn syncing off.
---

:::info Sample

Written for [Status](https://status.app/). Co-authored with [jorge-campo](https://github.com/jorge-campo). Published at [status.app/help/profile/sync-your-profile-across-devices](https://status.app/help/profile/sync-your-profile-across-devices).
...
<Admonition type="tip">
  You can use this procedure to [sign in to your profile on a new device](https://status.app/help/profile/sign-in-to-your-status-profile-on-a-new-device).
</Admonition>
...
<Admonition type="info">
  Your password and messages are not part of your profile data. If you [change your password](https://status.app/help/profile/change-your-status-password) on one device, you need to manually update it on all devices where you use Status.
</Admonition>
