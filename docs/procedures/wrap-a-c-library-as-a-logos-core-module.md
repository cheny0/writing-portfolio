...
sidebar_position: 1
description: >-
  A sectioned procedure for C++ developers: linking a C shared library into a Qt plugin and re-exposing its functions through Logos Core's meta-object system.
---

:::info Sample

Written for [Logos](https://github.com/logos-co/logos-docs). Published as [`wrap-a-c-library-as-a-logos-core-module.md`](https://github.com/logos-co/logos-docs/blob/main/docs/core/build-modules/wrap-a-c-library-as-a-logos-core-module.md).
...
For other module types, check out [Build and run a Logos core module](https://github.com/logos-co/logos-docs/blob/main/docs/core/build-modules/build-and-run-a-logos-core-module.md), Build a QML UI for your logos module and [Build a Logos C++ UI module](https://github.com/logos-co/logos-docs/blob/main/docs/core/build-modules/build-a-logos-cpp-ui-module.md).
...
The remaining work is identical to a [plain core module](https://github.com/logos-co/logos-docs/blob/main/docs/core/build-modules/build-and-run-a-logos-core-module.md). The LGX packager bundles the C library next to the plugin binary, so the RPATH lookup works at runtime.
...
Package the build output into an `.lgx` before running with `logoscore` or installing into `logos-basecamp`. See the [LGX package format and bundling reference](https://github.com/logos-co/logos-docs/blob/main/docs/core/reference/lgx-package-format-and-bundling-reference.md) for details.
...
Two runtimes can load your module: `logoscore` and `logos-basecamp`. To interact with the module through the `logos-basecamp` UI, you also need to provide a UI module.
...
Check out the [Logos CLI Reference](https://github.com/logos-co/logos-docs/blob/main/docs/core/reference/logos-cli-reference.md) for more details on available commands and options.
...
The LGX variant must match the basecamp build type. Dev basecamp expects dev variants (e.g. `darwin-arm64-dev`). Portable expects portable variants (e.g. `darwin-arm64`). See the [LGX package format and bundling reference](https://github.com/logos-co/logos-docs/blob/main/docs/core/reference/lgx-package-format-and-bundling-reference.md).
